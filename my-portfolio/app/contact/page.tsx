...
export default function Contact() {
  ...
  <a className={styles.text} href="mailto:nourazekryart@gmail.com">nourazekryart@gmail.com</a>
</div>
        ...
        <div className={styles.linkContainer}>
            ...
            <a className={styles.text} href="https://www.github.com/in/nourazekry" target="_blank" rel="noopener noreferrer">github.com/nourazekry</a>
        </div>
        </div>
    </main>
  );
